 ...
 * X-COM Emitter class.
 */
class X_COM_Emitter extends Emitter	notplaceable;
 ...
 */
static final function ParticleSystem GetTemplateForDistance(const out array<DistanceBasedParticleEffects> TemplateList, vector SpawnLocation, WorldInfo WI)
{
